...
cloudStack.docs = {
    ...
    helpTemplateAccountUsername:{
    	desc:'Account of template eg. OS user name or FTP user name',
    	externalLink:''
    },
    helpTemplateAccountPassword:{
    	desc:'The account\'s password',
    	externalLink:''
    },
    helpTemplateAccountType:{
    	desc:'The account\'s type',
    	externalLink:''
    },
    helpPropertyAdd:{
    	desc:'设备编号根据设备类型来填写，填写规则为：例如设备类型选择了"交换机",那么设备编号填写时必须以"20"开头,根据设备类型下拉框数据,设备编号的前面两个数字分别对应为"12""20""21""22""30"',
    	externalLink:''
    },
    helpX86PropertyAdd:{
    	desc:'设备编号填写时必须以"10"开头',
    	externalLink:''
    },
    helpX96PropertyAdd:{
    	desc:'设备编号填写时必须以"11"开头',
    	externalLink:''
    },
