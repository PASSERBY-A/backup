...
(function(cloudStack, $) {
    $.extend(cloudStack, {
        ...
        sectionPreFilter: function(args) {
            ...
            if (isAdmin()) {
            	sections = ["dashboard", "instanceMenu","instances","hpux","resourceMenu", "system", "storage", "network", "templates", "property", "equipmentEnroll",
            	            "systemMenu", "accounts", "domains", "projects", "affinityGroups", "global-settings", "resourcePoolPermission",
            	            "logMenu", "events", "logs", "workOrders", "configuration", "statisticMenu", "resourceStatistics", "workOrderReport", "topData"];
//            	 sections = ["dashboard", "instances", "storage", "service","network", "templates", "accounts", "domains", "events", "system", "global-settings", "configuration", "projects",  "affinityGroups","property","logs","resourcePoolPermission","workOrders","resourceStatistics","workOrderReport","topData"];
            	 ...
            	 * 域管理员没有访问网络和模板的权限
            	 */
                sections = ["dashboard", "instances", "storage", "accounts", "domains", "events", "projects",  "affinityGroups","property","logs","workOrders"];
            } else if (g_userProjectsEnabled) {
                sections = ["dashboard", "instances", "storage", "accounts", "events", "projects", "affinityGroups","logs","workOrders"];
            } else { //normal user
                sections = ["dashboard", "instances", "storage",  "accounts", "events",  "affinityGroups","logs","workOrders"];
            }
                ...
                cloudStack.installWizard.check({
                    ...
                    response: {
                        success: function(args) {
                        	//增加&&false跳过向导页面
                            if (args.doInstall && isAdmin()&&false) {
