    ...
    <div id="template">
      ...
      <div class="login">
      	<div class="index_header">
			<div class="index_logoBar"><img width="500" height="100" src="images/logoIAAS_login.png"></div>
		</div>	
        <form>
          <!-- <div class="logo"></div> -->
          <div class="sz_logo">深圳移动云计算IAAS平台</div>
          <div class="fields">
            <!-- User name -->
              ...
              <div class="content">
                ...
                <div class="section select-zone">
                  ...
                  <div class="select-area">
                    <div class="desc"></div>
                     <!-- added by steven 在新增实例页面加上资源池选择下拉框 -->
                    <select name="poolid" class="required pool">
                    </select>
                    
                    <select name="zoneid" class="required zone">
            ...
            <div class="step network always-load" wizard-step-id="network">
              ...
              <div class="wizard-step-conditional select-network">
                <div class="content">
                 ...
                 <!-- removed by steven 2014/3/26  <div class="select-vpc">
                    <label>VPC:</label>
                 ...
                 <%-- removed by steven 2014/3/26   <div class="select new-network">
                    <table>
                      <thead>
                        <tr>
                            ...
                            <div class="select-container fixed">
                              <div class="select even">
                                ...
                                <div class="secondary-input hide-if-unselected">
                                 <div style="display:inline;"><input type="radio" width="100" name="defaultNetwork" value="new-network" wizard-field="default-network"/>&nbsp;
      ...
      <div class="system-dashboard-view">
        ...
        <div class="system-dashboard zone">
          ...
          <ul class="status_box good">
           <li class="block resourcepools">
              <span class="header">一级资源池</span>
              <span class="icon">&nbsp;</span>
              <span class="overview total" data-item="resourcePoolCount"></span>
              <span class="button view-all resourcepools"
                    view-all-title="一级资源池"
                    view-all-target="resourcepools"><fmt:message key="label.view.all"/></span>
            </li>
      ...
      <div class="dashboard admin">
       ...
       <!-- 消息记录 added by steven 2014-05-14-->
        <div class="dashboard-container sub message alerts">
          <div class="top">
            <div class="title"><span>消息</span></div>
            <div class="button view-all"></div>
          </div>
          <ul data-item="messages">
            <li class="error" concat-value="50">
              <div class="content">
                <span class="title" data-list-item="name">Alert 1</span>
                <span data-list-item="description">Alert 1</span> <label data-list-item="sent">Alert 1</label>
              </div>
            </li>
          </ul>
        </div>
...
         <h1>日志查询</h1>
		 <div>
		 	<form name="queryForm">
				<table width="100%">
					<input id="vm_page" class="queryForm w120" type="hidden" name="page_count" value="1"/>
        			<input id="vm_rowNum" class="queryForm w120" type="hidden" name="row_Num" value="20"/>
					<tr>
						<td>操作类型：
						<select name="operation" class="queryForm w100">
						...
						<td>开始时间：<input type="text" class="Wdate queryForm" id="d412" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'d413\')||\'2020-10-01\'}'})" name="startDate" value="" readonly="readonly"/>

						</td>
						<td>用户：<input id="loginName" class="queryForm w100"
							type="text" name="loginName" maxlength="45" /></td>
					</tr>
					<tr>
						<td>所属模块：<select name="module" class="queryForm w100">
            			<option value="">所有类型</option>
           				<option value="用户管理">用户管理</option>   
			            <option value="主机池管理">主机池管理</option>
			            <option value="IP池管理">IP池管理</option>	
			            <option value="模版管理">模版管理</option>
			            <option value="服务申请">服务申请</option>
			            <option value="服务审批">服务审批</option>
			            <option value="角色管理">角色管理</option>
			            <option value="虚机管理">虚机管理</option>
			            <option value="用户认证">用户认证</option>
			            </select></td>
						<td>结束时间： 
						<input type="text" class="Wdate queryForm" id="d413" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'d412\')}'})" name="endDate" value="" readonly="readonly"/>
						</td>
						<td><input id="bt_query" name="" class="isBTN btn-2"
							type="button" value="查询" onclick="" /> <input id="bt_reset"
							name="" class="isBTN btn-2" type="reset" value="重置" onclick="" />
						</td>
					</tr>
				</table>
			</form>
...
      </div>
    ...
    <script src="lib/flot/jquery.flot.categories.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="scripts/templatesAccount.js?t=<%=now%>"></script>
    <script type="text/javascript" src="scripts/ui-custom/resourceStructure.js?t=<%=now%>"></script>
    ...
    <script type="text/javascript" src="scripts/hpux.js?t=<%=now%>"></script>
	<script type="text/javascript" src="scripts/hphost.js?t=<%=now%>"></script>
    <script type="text/javascript" src="scripts/resourcepools.js?t=<%=now%>"></script>
	...
	<script type="text/javascript" src="scripts/property.js?t=<%=now%>"></script>
	<script type="text/javascript" src="scripts/resourcePoolPermission.js?t=<%=now%>"></script>
	...
	<script type="text/javascript" src="scripts/service.js?t=<%=now%>"></script>
	<script type="text/javascript" src="scripts/topData.js?t=<%=now%>"></script>
	<script type="text/javascript" src="scripts/menu.js?t=<%=now%>"></script>
	<script type="text/javascript" src="scripts/resourcePoolShow.js?t=<%=now%>"></script>
	<script type="text/javascript" src="scripts/equipmentEnroll.js?t=<%=now%>"></script>
	<script type="text/javascript" src="scripts/hpHostManagement.js?t=<%=now%>"></script>
	<script type="text/javascript" src="scripts/devinfo.js?t=<%=now%>"></script>
