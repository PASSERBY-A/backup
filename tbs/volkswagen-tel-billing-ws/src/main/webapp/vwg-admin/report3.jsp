...
<script src="../js/pages/vwg-call-record/report3List.js" type="text/javascript"></script>

<script type="text/javascript">
backendRoleChecker.roleArray = ["EMERGENCY-USER","VCIC-CONTROLLING","VGIC-CONTROLLING","AUDI-CONTROLLING","VCRA-CONTROLLING"];
$(document).ready(function() {
	...
	$("#exportPar").click(function() {
    	...
    	var url = '<%=request.getContextPath()%>' + '/pdfprint'+"?type=report3&year="+year+'&month='+month+'&costcenter='+costcenter;
