...
var indexPage = {
	...
	initData : function(e) {
		var that = this;
		var config = {
			url : commons.webserversite + '/billCallRecordService/getBillCallRecordsByTelAndMonthAndUserId',
			type : 'POST',
	...
	createDataTable : function() {
		...
		datatableOnServer.sAjaxSource = commons.webserversite + '/billCallRecordService/getBillCallRecordsByTelAndMonthAndUserId'; 
		// define id position
		commons.xhId = 0;
