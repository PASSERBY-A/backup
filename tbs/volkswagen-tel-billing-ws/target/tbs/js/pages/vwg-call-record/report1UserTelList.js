...
var indexPage = {
	...
	isQuery : false,
	titleTextArray : [
		"User Id", "Telephone Number", "Show Uncompleted Month"
    ],
	ii : 0,
	init : function() {
		var that = this;
...
//               alert(bMonth + "/"+bYear+": "+bStatus);
              ...
              /**/
               ...
               if(bStatus=="ACTIVE")
               {
            	   ...
            	   cnt += "<span style='width: 130px; display: inline-block; text-align: right; margin-right: 100px;'>" + bMonth + "/" + bYear + "</span>"+"<span>" + bStatus + "</span>";
            	   cnt += "</div>";
               }
