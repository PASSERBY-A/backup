...
Ext.form.SelectDialogField = Ext.extend(Ext.form.ComboBox, {
	...
	**/
    ...
    if (!this.store && this.typeAheadUrl) {
...
Ext.form.CIField = Ext.extend(Ext.form.SelectDialogField, {
  ...
  onTrigger2Click : function(){
  	  ...
  	  var xposition = (screen.width - width) / 2;
		  var yposition = (screen.height - height) / 2;
		  var urls = (this.selectUrl?this.selectUrl:"/cmdb")+"/ciSearchDialog2.jsp?oid=" + this.getValue();
		  if (this.cicategory)
			  urls = (this.selectUrl?this.selectUrl:"/cmdb")+"/ciSearchList2.jsp?id=" + this.cicategory + "&oid=" + this.getValue();
