...
<body style="margin-bottom: 0px">
    ...
    <!--index_nav  layout-->
    	<ul class="index_nav">
                <li id="li5" onmouseover="action1(5)" class="nav_liOn"><a href="#" class="index_nav1">客户管理</a></li>
                <li id="li6" onmouseover="action1(6)"><a href="#" class="index_nav2">业务运营</a></li>
                <li id="li7" onmouseover="action1(7)"><a href="#" class="index_nav3">资源与监控</a></li>
                <li id="li8" onmouseover="action1(8)"><a href="#" class="index_nav4">统计报表 </a></li>
                <li id="li9" onmouseover="action1(9)"><a href="#" class="index_nav5">系统维护</a></li>
                <br class="clearfloat"/>
        </ul>
    	<div class="index_line2">
                 <ul class="index_SubNav Sub1" id="ul_block5" style="display:block;">
                 	<%
                 	...
                 	%>
                    <li><a href="#" onclick="openUrl('<%=menu.getOid() %>')" title="<%=menu.getAlt() %>"><%=StringUtil.escapeHtml(menu.getTitle()) %></a></li>
                    <%
                 		}
                    %>
                    <br class="clearfloat"/>
                 ...
                 <ul class="index_SubNav Sub3" id="ul_block7" style="display:none;">
                    <%
                 		...
                 		for(int i=0; i<list.size(); i++){
                 			Menu menu = list.get(i);
                 	%>
                    <li><a href="#" onclick="openUrl('')" title="<%=menu.getAlt() %>"><%=StringUtil.escapeHtml(menu.getTitle()) %></a></li>
                    <%} %>
                    <br class="clearfloat"/>
                </ul>
