...
var fld_ap = new Ext.form.TreeBox({fieldLabel:"允许人员",singleMode: false,pathMode:false,hiddenName:'fld_ap',viewLoader: new Ext.tree.FilterTreeLoader( {baseParams: {child:1, type:3,origin:'',showPerson:true},dataUrl:'<%=Consts.ITSM_HOME%>/ci/ciPersonTree.jsp'}),emptyText:'请选择...',desc:'',width:150});
var fld_rp = new Ext.form.TreeBox({fieldLabel:"拒绝人员",singleMode: false,pathMode:false,hiddenName:'fld_rp',viewLoader: new Ext.tree.FilterTreeLoader( {baseParams: {child:1, type:3,origin:'',showPerson:true},dataUrl:'<%=Consts.ITSM_HOME%>/ci/ciPersonTree.jsp'}),emptyText:'请选择...',desc:'',width:150});

var fld_ao = new Ext.form.TreeBox({fieldLabel:"允许组织",singleMode: false,pathMode:false,hiddenName:'fld_ao',viewLoader: new Ext.tree.FilterTreeLoader( {baseParams: {child:1, type:3,origin:''},dataUrl:'<%=Consts.ITSM_HOME%>/ci/ciPersonTree.jsp'}),emptyText:'请选择...',desc:'',width:150});
var fld_ro = new Ext.form.TreeBox({fieldLabel:"拒绝组织",singleMode: false,pathMode:false,hiddenName:'fld_ro',viewLoader: new Ext.tree.FilterTreeLoader( {baseParams: {child:1, type:3,origin:''},dataUrl:'<%=Consts.ITSM_HOME%>/ci/ciPersonTree.jsp'}),emptyText:'请选择...',desc:'',width:150});
var fld_ag = new Ext.form.TreeBox({fieldLabel:"允许工作组",singleMode: false,pathMode:false,hiddenName:'fld_ag',viewLoader: new Ext.tree.FilterTreeLoader( {baseParams: {child:1, type:1,origin:''},dataUrl:'<%=Consts.ITSM_HOME%>/ci/ciPersonTree.jsp'}),emptyText:'请选择...',desc:'',width:150});
var fld_rg = new Ext.form.TreeBox({fieldLabel:"拒绝工作组",singleMode: false,pathMode:false,hiddenName:'fld_rg',viewLoader: new Ext.tree.FilterTreeLoader( {baseParams: {child:1, type:1,origin:''},dataUrl:'<%=Consts.ITSM_HOME%>/ci/ciPersonTree.jsp'}),emptyText:'请选择...',desc:'',width:150});
var fld_al = new Ext.form.TreeBox({fieldLabel:"允许本地组",singleMode: false,pathMode:false,hiddenName:'fld_al',viewLoader: new Ext.tree.FilterTreeLoader( {baseParams: {child:1, type:1,origin:''},dataUrl:'<%=Consts.ITSM_HOME%>/configure/localgroup/localgroupTreeQuery.jsp'}),emptyText:'请选择...',desc:'',width:150});
var fld_rl = new Ext.form.TreeBox({fieldLabel:"拒绝本地组",singleMode: false,pathMode:false,hiddenName:'fld_rl',viewLoader: new Ext.tree.FilterTreeLoader( {baseParams: {child:1, type:1,origin:''},dataUrl:'<%=Consts.ITSM_HOME%>/configure/localgroup/localgroupTreeQuery.jsp'}),emptyText:'请选择...',desc:'',width:150});
...
var rulePanel_form =  new Ext.form.FormPanel({
    ...
    margins:'0 0 0 0',
		labelWidth:70,
		items:[
			fld_ap,fld_rp,fld_ao,fld_ro,fld_ag,fld_rg,fld_al,fld_rl,
		...
		tbar:[{text:'更新至表格',iconCls:'left',
			handler:function() {
				...
				var al = fld_al.getValue();
				var rl = fld_rl.getValue();
