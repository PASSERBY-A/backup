...
*/
//==================================================== WEB 页面显示部分 =====================================================
document.writeln('<div id=meizzDateLayer style="position: absolute; width: 160; height: 166; z-index: 9998; display: none" onselectstart="return false">');
document.writeln('<span id=tmpSelectYearLayer  style="z-index: 9999;position: absolute;top: 2; left: 38;display: none"></span>');
document.writeln('<span id=tmpSelectMonthLayer style="z-index: 9999;position: absolute;top: 2; left: 85;display: none"></span>');
document.writeln('<span id=tmpSelectHourLayer  style="z-index: 9999;position: absolute;top: 173; left: 40;display: none"></span>');
document.writeln('<span id=tmpSelectMinuteLayer  style="z-index: 9999;position: absolute;top: 173; left: 82;display: none"></span>');
document.writeln('<table border=0 cellspacing=1 cellpadding=0 width=160 height=160 bgcolor=#21284A Author="wayx">');
document.writeln('  <tr Author="wayx"><td width=150 height=23 Author="wayx" bgcolor=#FFFFFF><table border=0 cellspacing=1 cellpadding=0 width=160 Author="wayx" height=23>');
document.writeln('      <tr align=center Author="wayx"><td Author=meizz align=left><input Author=meizz type=button value="<<" title="向前翻 1 年" onclick="meizzPrevY()" ');
document.writeln('             onfocus="this.blur()" style="font-size: 12px; height: 20px"><input Author=meizz title="向前翻 1 月" type=button ');
document.writeln('             value="< " onclick="meizzPrevM()" onfocus="this.blur()" style="font-size: 12px; height: 20px"></td><td width=108 align=center style="font-size:12px;cursor:default" Author=meizz><span ');
...
document.writeln('        <td Author=meizz align=right><input Author=meizz type=button value=" >" onclick="meizzNextM()" ');
...
document.writeln('             onfocus="this.blur()" style="font-size: 12px; height: 20px"></td></tr></table></td></tr>');
document.writeln('  <tr Author="wayx"><td width=100% height=18 bgcolor=#21284A Author="wayx">');
document.writeln('<table border=0 cellspacing=0 cellpadding=0 width=100% height=1 Author="wayx" style="cursor:default">');
...
document.writeln('  <tr Author="wayx"><td width=100% height=120 Author="wayx">');
document.writeln('    <table border=0 cellspacing=1 cellpadding=0 width=100% height=120 Author="wayx" bgcolor=#FFFFFF>');
...
for (i=35;i<38;i++)document.write('<td width=20 height=20 id=meizzDay'+i+' style="font-size:12px" Author=wayx onclick="meizzDayClick(this.innerText,0)"></td>');
document.writeln('        <td colspan=4 Author=meizz align=right><input Author=meizz type=button value=今天 onclick="meizzToday()" ');
document.writeln('             onfocus="this.blur()" title="当前日期" style="font-size: 12px; height: 20px">&nbsp<span onclick=closeLayer() style="font-size:12px;cursor: hand"');
document.writeln('         Author=meizz title="Version:1.3&#13;作者: F.R.Huang(meizz)&#13;MAIL: meizz@hzcnc.com&#13;修改:FluteD"><u>关闭</u></span>&nbsp;</td></tr>');
document.writeln('    </table></td></tr><tr Author="wayx" id="selectTimeLayer"><td Author="wayx">');
document.writeln('        <table border=0 cellspacing=1 cellpadding=0 width=100% Author="wayx" bgcolor=#FFFFFF>');
document.writeln('          <tr Author="wayx"><td Author=meizz align=left><input Author=meizz type=button value="<<" title="向前翻一小时" onclick="meizzPrevH()" ');
document.writeln('             onfocus="this.blur()" style="font-size: 12px; height: 20px"><input Author=meizz title="向前翻 1 分钟" type=button ');
document.writeln('             value="< " onclick="meizzPrevMin()" onfocus="this.blur()" style="font-size: 12px; height: 20px"></td><td ');
document.writeln('             Author=meizz align=center style="font-size: 12px; height: 20px"><span onmouseover="style.backgroundColor=\'#B5BE63\'" ');
document.writeln('             onmouseout="style.backgroundColor=\'white\'" title="点击这里选择小时" Author=meizz id=meizzHourHead ');
document.writeln('             onclick="tmpSelectHourInnerHTML(this.innerText)"></span>');
document.writeln('             &nbsp;:&nbsp;<span id=meizzMinuteHead Author=meizz onmouseover="style.backgroundColor=\'#B5BE63\'" onmouseout="style.backgroundColor=\'white\'" ');
document.writeln('             title="点击这里选择分钟" onclick="tmpSelectMinuteInnerHTML(this.innerText)"></span></td><td ');
document.writeln('             Author=meizz align=right><input Author=meizz type=button value=" >" onclick="meizzNextMin()" ');
document.writeln('             onfocus="this.blur()" title="往后翻 1 分钟" style="font-size: 12px; height: 20px"><input ');
document.writeln('             Author=meizz type=button value=">>" title="往后翻 1 小时" onclick="meizzNextH()"');
document.writeln('             onfocus="this.blur()" style="font-size: 12px; height: 20px"></td>');
document.writeln('</tr></table></td></tr><tr Author="wayx" id="selectDateLayer"><td Author="wayx">');
document.writeln('        <table border=0 cellspacing=1 cellpadding=0 width=100% Author="wayx" bgcolor=#FFFFFF>');
...
function setday(tt,layer,obj) //主调函数
{
	...
	var meizzDateLayer = document.all.meizzDateLayer;
	...
	if(top + height > window.frameElement.offsetHeight) {
	...
	dads.left = tleft;
	outObject = (arguments.length != 3) ? th : obj;
	//根据当前输入框的日期显示日历的年月
