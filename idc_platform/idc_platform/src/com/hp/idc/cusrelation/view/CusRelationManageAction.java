package com.hp.idc.cusrelation.view;
 ...
 * 
 */
public class CusRelationManageAction extends AbstractAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6191807224237674733L;
	/**
	 * 
	 */
	...
	// 客户基本信息实体
	private CusManageInfo cusInfo;

	@Resource
	private CusRelationManageService cusRelationManageService;
	 ...
	 * @return
	 */
	public String toCustomerRelationManage() {
	 ...
	 * @return
	 */
	public String queryCustomerRelationInfo() {
		try {
			/****** 组装查询条件 Start ***********/
			...
			Page<CusManageInfo> page = cusRelationManageService.queryCustomerInfo(
					paramMap, sortMap, start / limit + 1, limit);
			List<CusManageInfo> list = page.getResult();
			...
			for (CusManageInfo customer : list) {
	 ...
	 * @return
	 */
	public String detailCustomerRelation() {
		if (id != null) {
			cusInfo = cusRelationManageService
	 ...
	 * @return
	 */
	public String queryContactRelation() {
		try {
			/****** 组装查询条件 Start ***********/
			Map<String, Object> paramMap = new HashMap<String, Object>();
			...
			/****** 组装查询条件 End ***********/
			LinkedHashMap<String, String> sortMap = new LinkedHashMap<String, String>();
			Page<CusManageContact> page = cusRelationManageService
					.queryCustomerContact(paramMap, sortMap, start / limit + 1,
							limit);
			List<CusManageContact> list = page.getResult();
			...
			for (CusManageContact contact : list) {
	...
	// }
	// /****** 组装查询条件 End ***********/
	// LinkedHashMap<String, String> sortMap = new LinkedHashMap<String,
	// String>();
	 ...
	 * @return
	 */
	 public String queryServantRelation() {
	 try {
	 /****** 组装查询条件 Start ***********/
	 Map<String, Object> paramMap = new HashMap<String, Object>();
	 ...
	 LinkedHashMap<String, String> sortMap = new LinkedHashMap<String,
	 String>();
	 Page<CusManageServant> page = cusRelationManageService.queryCustomerServant(
	 paramMap, sortMap, start / limit + 1, limit);
	 List<CusManageServant> list = page.getResult();
	 ...
	 JsonConfig jsonConfig = new JsonConfig();
	 jsonConfig.setExcludes(new String[] {
	 "createDate","validDate","expireDate","doneDate" });
	
	 for (CusManageServant servant : list) {
	...
	public CusManageInfo getCusInfo() {
		return cusInfo;
	}

	public void setCusInfo(CusManageInfo cusInfo) {
		this.cusInfo = cusInfo;
	}

	@Required
	public CusRelationManageService getCusRelationManageService() {
		return cusRelationManageService;
	}

	public void setCusRelationManageService(
			CusRelationManageService cusRelationManageService) {
		this.cusRelationManageService = cusRelationManageService;
	}
