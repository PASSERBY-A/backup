 ...
 * 
 */
public final class DateTimeAttributeDefine extends AttributeDefine {

	/**
	 * 序列化UID
	 */
	private static final long serialVersionUID = 2761868911507315521L;
	...
	public String valid(String value, String value1, String attrId, String op) {
		if (value == null || value.length() == 0)
			return null;
		String format = DateTimeAttribute.DATE_TIME_FORMAT;
