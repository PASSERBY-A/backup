package com.hp.idc.util
{
	...
	public class DateTimeUtil
	{
		...
		public static const CHINESE_DATETIME_FORMAT:String="YYYY-MM-DD JJ:NN:SS";
		...
		/**
		 * 将字符转换为Date 格式为YYYY-MM-DD JJ:NN:SS
		 */
		public static function stringToDateTime(valueString:String, inputFormat:String=CHINESE_DATETIME_FORMAT):Date
		{
...
//			JJ:NN:SS
		...
		/**
		 * 将字符转换为time的long值 格式为JJ:NN:SS
		 */
		public static function stringToTime(valueString:String, inputFormat:String):Number{
			var mask:String
			var temp:String;
			var hourString:String = "";
			var minuteString:String = "";
			...
			return hourNum*3600*1000+minuteNum*60*1000+secondNum*1000;
		}
	}
}