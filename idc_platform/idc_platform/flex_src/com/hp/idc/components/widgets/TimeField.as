package com.hp.idc.components.widgets
{
	...
	public class TimeField extends NumericStepper
	{
		...
		override protected function focusOutHandler(event:FocusEvent):void{
			...
			hours = parseInt(hoursInputField.text);
			minutes = parseInt(minutesInputField.text);
			hoursInputField.text=StringToolkit.formatNumberWithChar(hours,2,"0");
			minutesInputField.text=StringToolkit.formatNumberWithChar(minutes,2,"0");
		}
		...
		public function get time():Number{
			var time:Number = _hours*60*60*1000+_minutes*60*1000;
			return time;
		}
